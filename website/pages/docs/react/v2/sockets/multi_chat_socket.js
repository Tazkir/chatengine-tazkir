...
export default class Components extends Component {
  render() {
    return (
      <DocsLayout>
        <Head>
          <title>Multi Chat Socket | Chat Engine Docs</title>
          <meta
            name="description"
            content="How to subscrbe a User to all their Chats."
          />
        </Head>

        <Row>
          <Col xs={24} sm={20} md={16} style={styles.docsColumn}>
            <h1>Multi Chat Socket</h1>
            ...
            <div style={styles.body}>
              <span style={styles.codeLine}>{`<MultiChatSocket />`}</span> takes
              user authentication props, and subscribes to all (multiple)
              chatrooms which belong to this user, hence "Multi Chat".
            </div>

            <div style={styles.body}>
              Any apps with user-to-user chat functionality would use the{" "}
              <span style={styles.codeLine}>MultiChatSocket</span>.
            </div>
            ...
            <div style={styles.body}>
              In this example, the User will authenticate and console log any
              events which are relevant to them.
            </div>
            ...
            <div style={styles.body}>
              In order to pickup on messages sent to this user, the socket needs
              to authenticate the user for Security purposes.
            </div>
            ...
            <div style={styles.body}>
              Authentication flow: The Socket checks if there is a user (with{" "}
            ...
            <div style={styles.body}>
              (The secret matching is done by hash, we do <i>not</i> store
              plain-text secrets!)
            </div>

            <div style={styles.body}>
              Once this step is complete, we can now listen for relevant events.
            </div>
            ...
            <div style={styles.body}>
              ...
              the server. The Chat Server sets the user as offine, and removes
              subscription details from caching.
            </div>
...
const App: React.FC = () => {
  return (
    <MultiChatSocket
      ...
      onNewChat={(chat) => console.log("chat created", chat)}
